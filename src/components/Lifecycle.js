...
const Lifecycle = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      console.log('CleanUp useEffect useEffect []');
    };
  }, []);
  ...
  useEffect(() => {
    ...
    return () => {
      console.log('CleanUp useEffect useEffect [counter1]');
    };
  }, [counter1]);
  ...
  useEffect(() => {
    ...
    return () => {
      console.log('CleanUp useEffect useEffect [counter2]');
    };
  }, [counter2]);
  ...
  useEffect(() => {
    ...
    return () => {
      console.log('CleanUp useEffect useEffect [counter1, counter2]');
    };
  }, [counter1, counter2]);
